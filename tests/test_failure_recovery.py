...
from reconpilot.failure_recovery import (
...
def test_malformed_or_validation_error_is_not_retried():
    calls = 0
    sleeps = []
...
def test_no_candidate_style_failure_can_be_handled_without_crashing():
    def operation():
...
def test_batch_can_continue_after_one_failed_operation():
    results = []
